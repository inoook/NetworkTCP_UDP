...
// http://msdn.microsoft.com/ja-jp/library/5w7b7x5f(v=vs.80).aspx
using UnityEngine;
...
public class AsyncTcpServer
{
	...
	public delegate void MessageBytesReceivedHandler(byte[] bytes);
	public event MessageBytesReceivedHandler MessageBytesReceived;

	public delegate void MessageReceivedHandler(string msg);
	public event MessageReceivedHandler MessageReceived;
	
	public delegate void ClientHandler();
	public event ClientHandler ConnectClient;
	public event ClientHandler DisConnectClient;
